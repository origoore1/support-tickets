-- Lindgren-X v2 Schema (PostGIS-free version)
-- Uses JSONB for geometry storage instead of PostGIS GEOMETRY type
...
CREATE TABLE harmonized_claims (
    ...
    geometry_json JSONB,  -- GeoJSON geometry (no PostGIS required)
...
CREATE INDEX idx_harmonized_claims_geometry ON harmonized_claims USING GIN(geometry_json);
...
-- View for opportunity summary (joins claims with opportunities)
